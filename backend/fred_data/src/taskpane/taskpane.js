...
// -----------------------------
// This is a function from Office.js API it only executes AFTER excel has finished loading.
// It makes sure that any code does not run before office javascript runtime is ready.
Office.onReady(() => {
